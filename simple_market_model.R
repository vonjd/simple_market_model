...
#para_plot <- par(mfrow=c(3, 1)) #comment out before creating word doc
...
abline(h = 0.5)
#layout(matrix(c(1, 2, 3, 3, 4, 4), 3, 2, byrow = TRUE)) #comment out before creating word doc
plot(density(returns), main = "", ylab = "prob density", xlab = "return")
...
#par(para_plot) #comment out before creating word doc
